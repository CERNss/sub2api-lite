...
const documentUrl = computed(() => {
  if (getLocale() === 'zh') {
    return complianceStore.status?.document_url_zh || 'https://github.com/CERNss/sub2api-lite/blob/develop-lite/docs/legal/admin-compliance.zh.md'
  }
  return complianceStore.status?.document_url_en || 'https://github.com/CERNss/sub2api-lite/blob/develop-lite/docs/legal/admin-compliance.en.md'
})
