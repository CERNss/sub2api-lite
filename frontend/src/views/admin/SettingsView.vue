...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/CERNss/sub2api-lite/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/CERNss/sub2api-lite/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/CERNss/sub2api-lite/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/CERNss/sub2api-lite/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
