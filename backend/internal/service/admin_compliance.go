...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/CERNss/sub2api-lite/blob/develop-lite/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/CERNss/sub2api-lite/blob/develop-lite/docs/legal/admin-compliance.en.md"
