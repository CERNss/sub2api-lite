...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "Sub2API Lite", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "Sub2API Lite", "https://example.com/reset", "en-US"))
...
func (s *notificationEmailTestSMTPServer) settings() map[string]string {
	...
	return map[string]string{
		...
		SettingKeySMTPFromName: "Sub2API Lite",
