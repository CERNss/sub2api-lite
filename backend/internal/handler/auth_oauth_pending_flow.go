...
import (
	...
	"github.com/CERNss/sub2api-lite/internal/pkg/oauth"
...
func (h *AuthHandler) createPendingOAuthAccount(c *gin.Context, provider string) {
	...
	requireLocalEmailVerification := h.pendingOAuthLocalEmailVerificationRequired(c.Request.Context(), session, email)
