...
# Sub2API Lite 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/CERNss/sub2api-lite/develop-lite/deploy/install.sh | bash
#
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="Sub2API Lite 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 Sub2API Lite 服务："
    ...
    ["not_installed"]="Sub2API Lite 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 Sub2API Lite。"
    ...
    ["uninstall_complete"]="Sub2API Lite 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 Sub2API Lite"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 Sub2API Lite"
    ...
    ["server_config_desc"]="配置 Sub2API Lite 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Completion
    ["install_complete"]="Sub2API Lite installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start Sub2API Lite service:"
    ...
    # Upgrade
    ["upgrading"]="Upgrading Sub2API Lite..."
    ...
    ["not_installed"]="Sub2API Lite is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove Sub2API Lite from your system."
    ...
    ["uninstall_complete"]="Sub2API Lite has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install Sub2API Lite"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove Sub2API Lite"
    ...
    ["server_config_desc"]="Configure Sub2API Lite server listen address"
